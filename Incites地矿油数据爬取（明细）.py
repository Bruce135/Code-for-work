...
#df = df.groupby('学科代码')['ISSN'].apply(list).reset_index()
...
for name in range(0,dky.shape[0]):
    ...
    #     special_org = ['Institute of Disaster Prevention, CEA','Mayo Clinic','UTMD Anderson Cancer Center','Chinese Academy of Medical Sciences - Peking Union Medical College','University of Nebraska Medical Center','University of Mississippi Medical Center','Academy of Scientific & Innovative Research (AcSIR)','ICAR - Indian Veterinary Research Institute','ICAR - National Dairy Research Institute','Institut Polytechnique de Paris']
#         special_org = ['China University of Geosciences','China University of Mining & Technology','China University of Petroleum']
        ...
        body2 = {"filters":{"period":{"is":[2019,2023]},
            ...
            "geographicCollabType":{"is":"All"},
            "articletype":{"is":df.iloc[i,4]},
            # "orgname":{"is":['Institute of Disaster Prevention, CEA','Mayo Clinic','UTMD Anderson Cancer Center','Chinese Academy of Medical Sciences - Peking Union Medical College','University of Nebraska Medical Center','University of Mississippi Medical Center','Academy of Scientific & Innovative Research (AcSIR)','ICAR - Indian Veterinary Research Institute','ICAR - National Dairy Research Institute','Institut Polytechnique de Paris']},
            "schema":{"is":"Web of Science"},
            "issn":{"is":df.iloc[i,3]},
            "earlyAccess":{"is":[1]},
            "publisherType":{"is":"All"},
